...
//Если нужно увеличить и при этом получить значение переменной до увеличения – 
//нужна постфиксная форма:
let counter4 = 0;
alert(counter4++); // 0
...
alert(++v); // 2, префиксная форма возвращает новое значение
alert(m++); // 1, постфиксная форма возвращает старое значение
alert(v); // 2, значение увеличено один раз
alert(m); // 2, значение увеличено один раз
...
/*
"" + 1 + 0 ="10" Сложение со строкой "" + 1 преобразует 1 к строке: "" + 1 = "1"
"" - 1 + 0 = -1 Вычитание работает только с числами,
true + false = 1
6 / "3" = 2
"2" * "3" = 6
4 + 5 + "px" = "9px"
...
*/
let j = prompt("Первое число?", 1);
let l = prompt("Второе число?", 2);
